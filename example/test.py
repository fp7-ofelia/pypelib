...
#table.addRule('if vm.memory < 2000 then accept do project.string denyMessage You requested more that 2GB of RAM # descr',True)
t2.addRule('if project.vms > 2 then deny nonterminal do project.string denyMessage You requested more that 2 of vms # descr',False)
...
table.moveRule('if project.vms > 2 then deny nonterminal do project.string denyMessage You requested more that 2 of vms   #descr',0)
