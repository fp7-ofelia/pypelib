...
print "\n\nCOLLECTIONS:"
#collections
parseDumpAndCraft(" if  A in collection {2,3,4}  then accept do C # dd")
parseDumpAndCraft(" if  not A in collection {2,3,4}  then accept do C # dd")
...
print "\n\nRANGE  STRICT:"
#range no strict
parseDumpAndCraft(" if   A in range {2,4}  then accept terminal do C # dd")
parseDumpAndCraft(" if  not A in range {2,4}  then accept terminal do C # dd")
parseDumpAndCraft(" if   A not in range {2,4}  then accept terminal do C # dd")
...
parseDumpAndCraft(" if   ( (( (a>5) && (B = 5)) || (a=b) ) && ((a<4)&&(b!=5)))   then accept do something denyMessage ksdfkdfskf # comment")
